...
void Lab10::CreateFramebuffer(int width, int height)
{
...
void Lab10::DrawObjects(Shader *shader)
{
    for (int i = 0; i < 3; i++)
    {
...
void Lab10::RenderSimpleMesh(Mesh* mesh, Shader* shader, const glm::mat4& modelMatrix)
{
...
void Lab10::DrawFramebufferTextures()
{
...
void Lab10::RenderTextureScreen(Shader *shader, unsigned int textureID)
{
...
void Lab10::LoadShader(const std::string& name)
{
